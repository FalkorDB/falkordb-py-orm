...
def main():
    ...
    print(
        f"find_first_by_city('San Francisco'): {first_person[0].name if first_person else 'None'}"
    )

    top_3_oldest = repo.find_top_3_by_age_greater_than_order_by_age_desc(20)
    print("find_top_3_by_age_greater_than_order_by_age_desc(20):")
