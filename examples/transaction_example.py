...
def transfer_example():
    ...
    def transfer_money(from_user_id: int, to_user_id: int, amount: float):
        ...
        with Session(graph) as session:
            ...
            print(
                f"  Before: {from_user.username}=${from_user.balance}, {to_user.username}=${to_user.balance}"
            )
            ...
            print(
                f"  After: {from_user.username}=${from_user.balance}, {to_user.username}=${to_user.balance}"
            )
