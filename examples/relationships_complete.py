...
class Post:
    ...
    author: Optional[Person] = relationship(
        "AUTHORED", direction="INCOMING", target=Person, cascade=False
    )
...
def demonstrate_relationships():
    ...
    post1 = Post(title="Introduction to Python", content="Python is a great language...")
    post1.tags = [tech_tag, python_tag]

    post2 = Post(title="AI in 2025", content="Artificial intelligence continues to evolve...")
