...
def main():
    ...
    products = [
        Product(
            name="iPhone 15", price=999.99, category="Electronics", brand="Apple", status="Active"
        ),
        Product(
            name="MacBook Pro",
            price=2499.99,
        ...
        Product(
            name="iPad Air", price=599.99, category="Electronics", brand="Apple", status="Active"
        ),
        Product(
            name="Galaxy S24",
            price=899.99,
        ...
        Product(
            name="Nike Air Max", price=129.99, category="Footwear", brand="Nike", status="Active"
        ),
        Product(
            name="Nike Jordans", price=179.99, category="Footwear", brand="Nike", status="Active"
        ),
    ]
