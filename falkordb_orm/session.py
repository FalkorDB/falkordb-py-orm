...
class Session:
    """
    Session for managing entities with identity map and change tracking.
    ...
    def __init__(self, graph: Any):
        ...
        # Using WeakValueDictionary to allow garbage collection
    ...
    def flush(self) -> None:
        ...
        Example:
            ...
            >>> session.add(person2)
            >>> session.commit()  # Execute second INSERT and commit
        """
        if self._closed:
            raise RuntimeError("Session is closed")
    ...
    def _insert_entity(self, entity: Any) -> None:
        """
    ...
    def _update_entity(self, entity: Any) -> None:
        """
